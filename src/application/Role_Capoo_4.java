...
public class Role_Capoo_4 {
	...
	private double x, y;
	private String my_png = "role_4.png";

	public Role_Capoo_4(Client client, ClientCenter clientCenter, ImageView img_room, Label label_room_headpicture) {
		this.client = client;
	...
	private void setImage() {
		Platform.runLater(() -> {
			try {
				img_room = new ImageView("lock_role_4.png");
			} catch (Exception ex) {
				ex.printStackTrace();
			}
		});
