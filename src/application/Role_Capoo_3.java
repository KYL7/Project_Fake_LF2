...
public class Role_Capoo_3 {
	...
	private double x, y;
	private String my_png = "role_3.png";

	public Role_Capoo_3(Client client, ClientCenter clientCenter, ImageView img_room, Label label_room_headpicture) {
		this.client = client;
	...
	private void setImage() {
		Platform.runLater(() -> {
			try {
				img_room = new ImageView("lock_role_3.png");
			} catch (Exception ex) {
				ex.printStackTrace();
			}
		});
